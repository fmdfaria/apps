...
export default function AnexosProfissionaisModal({
  showModal,
  profissional,
  anexoFiles,
  anexoDescricao,
  ...
  const handleSalvarAnexo = async () => {
    ...
    try {
      ...
      const anexosDb = await getAnexos(profissional.id);
    ...
    <>
      <Dialog open={showModal} onOpenChange={onClose}>
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          <DialogHeader className="bg-gradient-to-r from-violet-50 to-purple-50 -mx-6 -mt-6 px-6 pt-6 pb-4 border-b border-gray-200">
            <DialogTitle className="text-xl font-bold text-gray-900 flex items-center gap-3">
              <span className="text-2xl">📎</span>
              Anexos - {profissional?.nome}
            </DialogTitle>
          </DialogHeader>
          ...
          <div className="mt-4 flex flex-col gap-3">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-gradient-to-r from-violet-50 to-purple-50 rounded-xl p-3 border-2 border-violet-200">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 focus:ring-4 focus:ring-violet-100 focus:border-violet-500 transition-all duration-200 hover:border-violet-300"
              ...
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-3 border border-gray-200">
                ...
                {anexos.length === 0 ? (
                  ...
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                    {anexos.map((anexo) => (
                      <div key={anexo.id} className="flex items-center gap-2 p-2 bg-white rounded-lg border border-gray-200 hover:border-violet-300 transition-colors">
            ...
            <DialogFooter className="mt-6">
              ...
              <Button
                ...
                disabled={saving}
                className="bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 shadow-lg hover:shadow-xl font-semibold px-8 transition-all duration-200 "
              >
                {saving ? (
                  <>
                    <span className="mr-2">⏳</span>
