                        ...
                        {canDeleteAnexoForId(anexo.id) ? (
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <span className="inline-block">
                                  <Button 
                                    ...
                                    size="sm"
                                    variant="outline"
                                    className="group border border-red-200 text-red-300 h-6 w-6 p-0 cursor-not-allowed"
                                    disabled
                                  >
                                    <span className="sr-only">Excluir</span>
                                    <span className="text-xs">×</span>
                              ...
                              <TooltipContent>
                                <p>Você não tem permissão para excluir anexos</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        )}
              ...
              {canUpload ? (
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="inline-block">
                        <Button
                          type="button"
                          disabled
                          className="bg-gradient-to-r from-teal-600 to-emerald-600 opacity-50 cursor-not-allowed font-semibold px-8"
                        >
                          <span className="mr-2">🟢</span>
                          Salvar
                        </Button>
                    ...
                    <TooltipContent>
                      <p>Você não tem permissão para salvar anexos</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              )}
      ...
      <AlertDialog open={!!anexoToDelete} onOpenChange={open => !open && onAnexoToDeleteChange(null)}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            {anexoToDelete && !canDeleteAnexoForId(anexoToDelete.id) ? (
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span className="inline-block">
                      <AlertDialogAction 
                        disabled
                        className="bg-gradient-to-r from-red-600 to-red-700 opacity-50 cursor-not-allowed font-semibold"
                      >
