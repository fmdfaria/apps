...
export default function CriarPacienteModal({
  showModal,
  editando,
  form,
  formError,
  ...
  // Lógica para gerenciar o campo convênio baseado no tipo de serviço (apenas para criação)
  useEffect(() => {
  ...
  }, [form.tipoServico, form.convenioId, convenios]);
              ...
              <div>
                ...
                <div className="w-full">
                  <SingleSelectDropdown
                    ...
                    selected={getConvenioOptions().find(c => c.id === form.convenioId) ? {
                      id: form.convenioId,
                      nome: getConvenioOptions().find(c => c.id === form.convenioId)?.nome || ''
                    } : null}
                    onChange={(selected) => {
